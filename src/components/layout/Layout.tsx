        ...
        <div style={{ padding: "14px 16px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div style={{ color: "#475569", fontSize: 10, textTransform: "capitalize" }}>{user?.role || "viewer"}</div>
            </div>
          </div>
          <button
      ...
      <div style={{ marginLeft: 230, flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <div>
              <div style={{ color: "#e2e8f0", fontSize: 13, fontWeight: 600 }}>{user?.name || "Guest"}</div>
              <div style={{ color: "#475569", fontSize: 11, textTransform: "capitalize" }}>{user?.role || "viewer"}</div>
            </div>
          </div>
        </header>
